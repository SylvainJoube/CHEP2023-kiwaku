...
plot_diff = False # Plot values relative to covfie, or plot absolute values
...
if use_acts_field:
  ...
  # lorentz_covfie_list     = load_file("data/data7_blop_it10/covfie_lorentz_nanob_sclock_it10_blop-debian11_4096-4096_1024-65536_128-128_InterpolateLin-LayoutStride-field.txt")
  # lorentz_standalone_list = load_file("data/data7_blop_it10/lorentz_opti_nanob_sclock_it10_standalone_blop-debian11_4096-4096_1024-65536_128-128_acts-field.txt")
  # lorentz_kiwaku_list     = load_file("data/data7_blop_it10/lorentz_opti_nanob_sclock_it10_kiwaku_blop-debian11_4096-4096_1024-65536_128-128_acts-field.txt")
  
  lorentz_covfie_list     = load_file("data/d8_blop/covfie_lorentz_sclock_it10_blop-debian11_2-65536_1024_128_InterpolateLin-LayoutStride-field.txt")
  lorentz_standalone_list = load_file("data/d8_blop/lorentz_opti_sclock_it10_standalone_blop-debian11_2-65536_1024_128_acts-field.txt")
  lorentz_kiwaku_list     = load_file("data/d8_blop/lorentz_opti_sclock_it10_kiwaku_blop-debian11_2-65536_1024_128_acts-field.txt")
...
ptotal_1D   = pu.make_1D_list_every(lorentz_standalone_list, "particles", "steps", 1)
...
if plot_diff:
  compare_to_list = lorentz_covfie_list
...
pu.draw_violin_plot("green", make_violin_plot_list(lorentz_covfie_list, violin_keyword, compare_to_list))
...
if plot_diff:
  ldiff0 = pu.make_diff_list(lorentz_covfie_list, lorentz_standalone_list, plot_keyword)
  ldiff1 = pu.make_diff_list(lorentz_covfie_list, lorentz_covfie_list, plot_keyword)
  ldiff2 = pu.make_diff_list(lorentz_covfie_list, lorentz_kiwaku_list, plot_keyword)
else:
  ldiff0 = pu.make_absolute_list(lorentz_standalone_list, plot_keyword)
  ldiff1 = pu.make_absolute_list(lorentz_covfie_list, plot_keyword)
...
plt.title(computer_name + " - " + field_type_name + " - " + unit_name + ", lower is better - iterations per pt: " + str_min_iteration_count)
...
out_fname = computer_name + "_" + field_type_name + "_" + unit_name_file + "_" + pdiff_str + ".png"


# plt.ylabel('Elapsed time (µs)')
if plot_diff:
  plt.ylabel('Compared to covfie (%), lower is better')
else:
  if per_particle_values:
    if plot_cycles_instead_of_time:
...
plt.xlabel('(particles) - (steps) - (total count in millions (1e6))')
